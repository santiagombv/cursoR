...
#### Curso online  - Últimos dictados 
   
*15 de agosto al 8 de septiembre. Universidad Mayor Real y Pontificia San francisco Xavier de Chuquisaca.*   
...
Este [google docs](https://docs.google.com/document/d/1uNGGnfIdksu7ljGx9g3pUrwF3UZUUt3qZJ9bNQbZ6Hw/edit?usp=sharing) se encuentra habilitado para consultas. Algunas indicaciones de uso:   
* Iniciemos la pregunta/respuesta con el nombre.
* Cualquiera puede preguntar, cualquiera puede responder.
* Coloquemos mensajes claros, breves y respetuosos.
* Evitemos enviar mails con consultas. Todos podemos aprender de las dudas y soluciones de otras personas.


#### Encuentros: se enviarán los links de zoom o meet por e-mail.  

#### Cronograma   

* Módulo 1   
  + Teórico: ¿Por qué R? Contenido del curso. [PRESENTACIÓN](teoricos/teor1.html) -  [VIDEO](https://youtu.be/f94b7Zh7sp4)
  + Práctico guiado: Introducción al lenguaje. Ingreso y manipulación de datos. [PÁGINA](01 practico/practico01.html) - VIDEO: [parte 1](https://youtu.be/zRQvwcIbNnQ) - [parte 2](https://youtu.be/KZCUeTPqbGY) - [parte 3](https://youtu.be/6FNIWEGnmfQ) 
  + Trabajo práctico: preparación de datos, ingreso y manipulación.  
  + Encuentro 16/08/2023.    
