...
En download R for Windows - base, seleccionar la última versión disponible de R (4.2.0 "Vigorous Calisthenics" desde el 22 de abril de 2022). Guardar el archivo R-4.2.0-win.exe en cualquier parte de la computadora, ejecutarlo y seguir las instrucciones de instalación. 

### Instalación de RStudio

Descargar la última version de RStudio Desktop (version gratuita) desde https://www.rstudio.com/products/rstudio/download/ y seguir las instrucciones de instalación.    
...
> Se recomienda fuertemente seguir este curso con una *versión actualizada de R y RStudio*. En caso de tener problemas con la actualización, desisntalar todas las versiones anteriores.
