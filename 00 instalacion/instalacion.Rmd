...
> Para este curso, se requieren los siguientes paquetes que no son descargados de forma automática con la instalación de R, por lo que deberá instalarlos manualmente: *arm*, *car*, *devtools*, *glmnet*, *GGally*, *ggplot2*, *lattice*, *leaps*, *MuMIn*, *rgl*, *rmarkdown*, *sciplot* y todas las dependencias necesarias.  
